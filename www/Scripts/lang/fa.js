...
(function (a, b) {
	...
	d = {
        ...
        (b.defineLocale || b.lang).call(b,
                "fa",
                {
                    //5th month name is "مرداد" not "امرداد".Amordad(امرداد): This is not an ordinary name, It's an old name and is not used now. اوت

                    months: "ژانویه_فوریه_مارس_آوریل_مرداد_ژوئن_ژوئیه_اوت_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
            ...
            a.fullCalendar.datepickerLang("fa",
                "fa",
                {
                    closeText: "بستن",
                    prevText: "&#x3C;قبلی",
