    ...
    public class PreventSpamAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            else
            {
                ...
                cache.Add(hashValue, new CacheItemWrapper { Value = null}, null, DateTime.Now.AddSeconds(DelayRequest), Cache.NoSlidingExpiration, CacheItemPriority.Default, null);
            }
